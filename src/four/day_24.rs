...
use crate::four::day_24::State::{DIRECT_AND, DIRECT_XOR, MERGE_OVERFLOW, PROBLEM, XOR_OUT};
...
#[test]
fn fuck_you() {
    let mut vec1 = vec!("z07", "rts", "jpj", "z12", "kgj", "z26", "chv", "vvw");
    vec1.sort();
    println!("{}", vec1.join(","));
}
...
#[test]
fn solve_() {
    let contents = fs::read_to_string("/home/jan/Documents/advent_of_rust/src/input_2")
        .expect("This is the error message");
